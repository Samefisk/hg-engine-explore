...
$(COMPILE_CONFIG_STAMP): FORCE_COMPILE_CONFIG | $(BUILD)
	@{ \
		printf '%s\n' 'CC=$(CC)' \
			...
			'OVERWORLD_WILD_RUNTIME_OVERLAY_CFLAGS=$(OVERWORLD_WILD_RUNTIME_OVERLAY_CFLAGS)' \
