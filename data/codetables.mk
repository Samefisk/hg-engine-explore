...
OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN := data/OverworldWildBehaviorV39.frozen.json.gz
OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_MANIFEST := data/OverworldWildBehaviorV39.frozen.manifest.json
OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_LOADER := scripts/overworld_wild_behavior_v39_frozen.py
OVERWORLD_WILD_BEHAVIOR_DATA_REGISTRY := data/OverworldWildBehaviorV40StableIds.json
OVERWORLD_WILD_BEHAVIOR_DATA_REGISTRY_MANIFEST := data/OverworldWildBehaviorV40StableIds.manifest.json
...
OVERWORLD_WILD_BEHAVIOR_DATA_PROJECTION_VALIDATOR := scripts/validate_overworld_wild_behavior_v40_projection.py
...
OVERWORLD_WILD_BEHAVIOR_DATA_DEPENDENCIES := data/OverworldWildBehaviorData.c $(OVERWORLD_WILD_BEHAVIOR_DATA_GENERATED) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_MANIFEST) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_LOADER) $(OVERWORLD_WILD_BEHAVIOR_DATA_REGISTRY) $(OVERWORLD_WILD_BEHAVIOR_DATA_REGISTRY_MANIFEST) include/overworld_wild_behavior_data.h include/config.h include/constants/species.h $(OVERWORLD_WILD_BLOB_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_HOST_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_SHARED_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_TARGET_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_MALFORMED) $(OVERWORLD_WILD_BEHAVIOR_DATA_RESOLVER) $(OVERWORLD_WILD_BEHAVIOR_DATA_FIELD_METADATA) $(OVERWORLD_WILD_BEHAVIOR_DATA_PROJECTION_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_SWAP_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_VIEWER) $(VENV_ACTIVATE)
...
$(OVERWORLD_WILD_BEHAVIOR_DATA_GENERATED): $(OVERWORLD_WILD_BEHAVIOR_DATA_GENERATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_FIELD_METADATA) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_MANIFEST) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_LOADER) $(OVERWORLD_WILD_BEHAVIOR_DATA_REGISTRY) $(OVERWORLD_WILD_BEHAVIOR_DATA_REGISTRY_MANIFEST)
...
$(OVERWORLD_WILD_BEHAVIOR_DATA_BIN): $(OVERWORLD_WILD_BEHAVIOR_DATA_DEPENDENCIES)
	...
	$(PYTHON) $(OVERWORLD_WILD_BEHAVIOR_DATA_GENERATOR) --check --registry-history-self-test --raw-output $(BUILD)/OverworldWildBehaviorDataV40.expected.bin
...
OVERWORLD_WILD_BEHAVIOR_PROJECTION_GENERATED := data/OverworldWildBehaviorProjectionV40.generated.inc
OVERWORLD_WILD_BEHAVIOR_PROJECTION_BIN := build/OverworldWildBehaviorProjectionData.bin
OVERWORLD_WILD_BEHAVIOR_PROJECTION_OBJ := build/OverworldWildBehaviorProjectionData.o
OVERWORLD_WILD_BEHAVIOR_PROJECTION_DEPENDENCIES := data/OverworldWildBehaviorProjectionData.c $(OVERWORLD_WILD_BEHAVIOR_PROJECTION_GENERATED) $(OVERWORLD_WILD_BEHAVIOR_DATA_PROJECTION_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_MANIFEST) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_LOADER) include/overworld_wild_behavior_data.h $(VENV_ACTIVATE)

$(OVERWORLD_WILD_BEHAVIOR_PROJECTION_GENERATED): $(OVERWORLD_WILD_BEHAVIOR_DATA_PROJECTION_VALIDATOR) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_MANIFEST) $(OVERWORLD_WILD_BEHAVIOR_DATA_FROZEN_LOADER)
	$(PYTHON) $(OVERWORLD_WILD_BEHAVIOR_DATA_PROJECTION_VALIDATOR) --generate-inc $@

$(OVERWORLD_WILD_BEHAVIOR_PROJECTION_BIN): $(OVERWORLD_WILD_BEHAVIOR_PROJECTION_DEPENDENCIES)
	@echo "writing overworld wild behavior compatibility projection..."
	$(CC) $(CFLAGS) -c data/OverworldWildBehaviorProjectionData.c -o $(OVERWORLD_WILD_BEHAVIOR_PROJECTION_OBJ)
	$(OBJCOPY) -O binary $(OVERWORLD_WILD_BEHAVIOR_PROJECTION_OBJ) $@
	$(PYTHON) $(OVERWORLD_WILD_BEHAVIOR_DATA_PROJECTION_VALIDATOR) --projection $@
