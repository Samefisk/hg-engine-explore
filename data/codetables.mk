...
OVERWORLD_WILD_BEHAVIOR_DATA_BUILDER := scripts/build_overworld_wild_behavior_data.py
OVERWORLD_WILD_BEHAVIOR_DATA_CONSTANTS := \
	...
	scripts/generate_overworld_wild_behavior_data.py

$(OVERWORLD_WILD_BEHAVIOR_DATA_BIN): $(OVERWORLD_WILD_BEHAVIOR_DATA_BUILDER) $(OW_WILD_BEHAVIOR_PROFILE_JSON) $(OW_WILD_BEHAVIOR_DATA_GENERATED) $(OVERWORLD_WILD_BEHAVIOR_DATA_CONSTANTS)
	$(PYTHON_NO_VENV) $(OVERWORLD_WILD_BEHAVIOR_DATA_BUILDER) build \
		--input $(OW_WILD_BEHAVIOR_PROFILE_JSON) \
		--output $@

.PHONY: validate_owbd
validate_owbd: $(OVERWORLD_WILD_BEHAVIOR_DATA_BIN)
	$(PYTHON_NO_VENV) $(OVERWORLD_WILD_BEHAVIOR_DATA_BUILDER) validate $< \
		--source-json $(OW_WILD_BEHAVIOR_PROFILE_JSON)
	$(PYTHON_NO_VENV) $(OVERWORLD_WILD_BEHAVIOR_DATA_BUILDER) probe
