...
MessageFormat *LONG_CALL MessageFormat_New_Custom(u32 fieldCount, u32 fieldLength, u32 heapId);
void LONG_CALL MessageFormat_Delete(MessageFormat *msgFmt);
void LONG_CALL BufferIntegerAsString(MessageFormat *msgFmt, u32 fieldno, s32 number, u32 digits, u32 printingMode, BOOL useJapaneseCharset);
void LONG_CALL StringExpandPlaceholders(MessageFormat *msgFmt, String *dest, const String *src);
