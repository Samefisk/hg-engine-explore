...
OVERWORLD_WILD_ENCOUNTER_DATA_TARGET := $(BUILD)/a028/9_18
OVERWORLD_WILD_ENCOUNTER_DATA_BIN := $(BUILD)/OverworldWildEncounterData.bin
OVERWORLD_WILD_ENCOUNTER_DATA_BUILDER := scripts/build_overworld_wild_encounter_data.py

$(OVERWORLD_WILD_ENCOUNTER_DATA_BIN): $(OVERWORLD_WILD_ENCOUNTER_DATA_BUILDER) $(ENCOUNTER_NARC)
	$(PYTHON_NO_VENV) $(OVERWORLD_WILD_ENCOUNTER_DATA_BUILDER) build \
		--input-dir $(ENCOUNTER_DIR) \
		--output $@

.PHONY: validate_owed
validate_owed: $(OVERWORLD_WILD_ENCOUNTER_DATA_BIN)
	$(PYTHON_NO_VENV) $(OVERWORLD_WILD_ENCOUNTER_DATA_BUILDER) validate $< \
		--input-dir $(ENCOUNTER_DIR)
	$(PYTHON_NO_VENV) $(OVERWORLD_WILD_ENCOUNTER_DATA_BUILDER) probe

NARC_FILES += $(OVERWORLD_WILD_ENCOUNTER_DATA_BIN)
