...
OVERWORLDS_SHINY_DIR := $(BUILD)/pokemonow_shiny
OVERWORLDS_SHINY_NARC := $(BUILD_NARC)/pokemonow_shiny.narc
OVERWORLDS_SHINY_TARGET := $(FILESYS)/a/2/7/0
...
$(OVERWORLDS_SHINY_NARC): $(ALL_OVERWORLDS_SRCS) $(OVERWORLDS_SHINY_GENERATOR_DEPS)
	...
	rm -rf $(OVERWORLDS_SHINY_DIR)
	mkdir -p $(OVERWORLDS_SHINY_DIR)
	for file in $(OVERWORLDS_SHINY_GENERATED_DIR)/*.png; do $(BTX) $$file $(OVERWORLDS_SHINY_DIR)/1_$$(basename $$file .png).btx0; done
	$(NARCHIVE) create $@ $(OVERWORLDS_SHINY_DIR) -nf

NARC_FILES += $(OVERWORLDS_NARC) $(OVERWORLDS_SHINY_NARC)
REQUIRED_DIRECTORIES += $(OVERWORLDS_DIR) $(OVERWORLDS_SHINY_GENERATED_DIR) $(OVERWORLDS_SHINY_DIR) $(dir $(OVERWORLDS_SHINY_TARGET))
