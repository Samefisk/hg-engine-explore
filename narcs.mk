...
HEADBUTT_GENERATOR := scripts/build_headbutt_tree_data.py

$(HEADBUTT_NARC): $(HEADBUTT_DEPENDENCIES) $(HEADBUTT_GENERATOR)
	rm -rf $(HEADBUTT_DIR)
	mkdir -p $(HEADBUTT_DIR)
	$(ARMIPS) $(HEADBUTT_DEPENDENCIES)
	$(PYTHON) $(HEADBUTT_GENERATOR) pack --input-dir $(HEADBUTT_DIR) --output $@
	$(PYTHON) $(HEADBUTT_GENERATOR) validate --narc $@
