...
_Static_assert(sizeof(OverworldWildRuntimeResolvedStaticContext) == 60, "resolved static context layout changed");
_Static_assert(sizeof(OverworldWildRuntimeRecoveryCandidate) == 16, "recovery candidate layout changed");
_Static_assert(sizeof(OverworldWildRuntimeCommandIdentity) == 20, "command identity layout changed");
_Static_assert(sizeof(OverworldWildRuntimeCommandOrigin) == 52, "command origin layout changed");
_Static_assert(sizeof(OverworldWildRuntimeCommandOriginBank) == 520, "command origin bank layout changed");
_Static_assert(sizeof(OverworldWildRuntimeTimerRecoveryResult) == 44, "timer recovery result layout changed");
