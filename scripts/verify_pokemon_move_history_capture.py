...
OVERLAY155_PRIVATE_CALL_INVENTORY_SHA256 = (
    "be53e561c05b4bc359ce363ca64f032e9cb5b0e14fd6b8ccd6b2b0078d1a0867"
)
...
EXPECTED_INCLUDED_MAKE_SOURCES = {
    "data/codetables.mk":
        "7ec222cd1f00951e6b52d98b202a2fd71c2d3037c938e44447df22ce4a27cef6",
    ...
    "overlays.mk":
        "90d1c6677f6a8eea5291c5899faf7f984947a50bad99716c4e65bd9e85b72177",
}
MANAGED_BUILD_PATH = (
...
OVERLAY129_THUNKS = {
    0x023DA88E: bytes.fromhex("18 47"),
    0x023DA894: bytes.fromhex("30 47"),
    0x023DCB3C: bytes.fromhex("18 47"),
    0x023DCB40: bytes.fromhex("28 47"),
    0x023DE0F2: bytes.fromhex("18 47"),
    0x023DE0F4: bytes.fromhex("30 47"),
    0x023DE0F6: bytes.fromhex("38 47"),
}
...
def binary_contracts(rom_path: Path, manifest_path: Path) -> None:
    ...
    packaged_function_specs = (
        (
            ...
            [
                (0x023DD6FC, "bl", 0x023DE0F2),
                (0x023DD704, "bl", 0x023DE0F2),
            ],
        ),
        (
            "Save_LoadDynamicRegion",
            ...
            [
                (0x023DD8E4, "bl", 0x023DE0F4),
                (0x023DD8F2, "bl", 0x023DD80C),
                (0x023DD902, "bl", 0x023DE0F4),
                (0x023DD914, "bl", 0x023DD80C),
                (0x023DD930, "bl", 0x023DE0F6),
                (0x023DD948, "bl", 0x023DE0F6),
                (0x023DD954, "bl", 0x023DE0F2),
                (0x023DD95C, "bl", 0x023DE0F2),
                (0x023DD964, "bl", 0x023DE0F2),
            ],
        ),
        (
            "Save_WriteManInit",
            ...
            [
                (0x023DDA44, "bl", 0x023DE0F2),
                (0x023DDA4C, "bl", 0x023DE0F2),
                (0x023DDA70, "bl", 0x023DE0F2),
                (0x023DDA78, "bl", 0x023DE0F2),
            ],
        ),
        (
            "Save_WriteManFinish",
            ...
            [
                (0x023DDACE, "bl", 0x023DE0F2),
                (0x023DDAD6, "bl", 0x023DE0F2),
                (0x023DDADE, "bl", 0x023DE0F2),
                (0x023DDAF2, "bl", 0x023DE0F2),
            ],
        ),
        (
            "Save_PrepareForAsyncWrite",
        ...
        (
            ...
            [
                (0x023DE072, "bl", 0x023DDF34),
                (0x023DE082, "bl", 0x023DDAA8),
                (0x023DE08C, "bl", 0x023DE0F2),
            ],
        ),
        (
            "CancelAsyncSaveWithMoveHistory",
            ...
            [
                (0x023DDB50, "bl", 0x023DE0F2),
                (0x023DDB5A, "bl", 0x023DE0F2),
                (0x023DDB68, "bl", 0x023DE0F2),
                (0x023DDB70, "bl", 0x023DE0F2),
                (0x023DDB7C, "bl", 0x023DE0F2),
                (0x023DDB84, "bl", 0x023DE0F2),
            ],
        ),
        (
            "Save_Cancel",
        ...
        (
            ...
            [
                (0x023DDC3C, "bl", 0x023DE0F2),
                (0x023DDC4A, "bl", 0x023DE0F2),
                (0x023DDC56, "bl", 0x023DE0F2),
                (0x023DDC5C, "bl", 0x023DE0F2),
                (0x023DDC7A, "bl", 0x023DE0F2),
                (0x023DDC84, "bl", 0x023DDBB8),
                (0x023DDC8C, "bl", 0x023DE0F2),
                (0x023DDCAC, "bl", 0x023DD6E4),
                (0x023DDCB4, "bl", 0x023DD8D0),
                (0x023DDCCE, "bl", 0x023DE0F2),
                (0x023DDCF4, "bl", 0x023DE0F2),
            ],
        ),
        (
            "PartyMenu_LearnMoveToSlot",
            ...
            [
                (0x023DA184, "bl", 0x023DA88E),
                (0x023DA1A0, "bl", 0x023DA894),
                (0x023DA1A8, "bl", 0x023DA88E),
                (0x023DA1B4, "bl", 0x023DA88E),
                (0x023DA1BE, "bl", 0x023DA88E),
            ],
        ),
        (
            "MonTryLearnMoveOnLevelUp",
            ...
            [
                (0x023DC738, "bl", 0x023DCB3C),
                (0x023DC746, "bl", 0x023DCB40),
                (0x023DC752, "bl", 0x023DCB40),
                (0x023DC75E, "bl", 0x023DCB40),
                (0x023DC770, "bl", 0x023DCB3C),
                (0x023DC7BE, "bl", 0x023DCB3C),
                (0x023DC7CC, "bl", 0x023DCB3C),
                (0x023DC7E4, "bl", 0x023DCB3C),
                (0x023DC826, "bl", 0x023DCB3C),
                (0x023DC83A, "bl", 0x023DCB3C),
                (0x023DC84A, "bl", 0x023DCB3C),
            ],
        ),
        (
            "PokemonMoveHistory_RecordMoveImpl",
    ...
    for literal_address, expected_target in (
        (0x023DD718, OVERLAY_BASE + 0x11),
        (0x023DD998, OVERLAY_BASE + 0x49),
        (0x023DDA90, OVERLAY_BASE + 0x51),
        (0x023DDB18, OVERLAY_BASE + 0x59),
        (0x023DDBA0, OVERLAY_BASE + 0x61),
        (0x023DDD24, OVERLAY_BASE + 0x01),
    ):
        require(
            struct.unpack_from(
                "<I",
    ...
    for hook_address, expected_bytes in (
        (0x020271B0, "00 48 00 47 35 dc 3d 02"),
        (0x020274A8, "00 49 08 47 e5 d6 3d 02"),
        (0x02027550, "00 4a 10 47 95 da 3d 02"),
        (0x02027564, "00 49 08 47 61 e0 3d 02"),
        (0x020275A4, "00 49 08 47 a9 db 3d 02"),
        (0x02027AD4, "00 49 08 47 d1 d8 3d 02"),
        (0x02027BDC, "00 4b 18 47 3d da 3d 02"),
        (0x02027CEC, "00 4b 18 47 a9 da 3d 02"),
    ):
        require(
    ...
    party_body = bytes_at(packaged_ov129, ov129_base, 0x023DA174, 0x6C)
    require(
    ...
    mutated_thunk[0x023DA88E - ov129_base] = 0x20
    require(
    ...
    level_body = bytes_at(packaged_ov129, ov129_base, 0x023DC724, 0x158)
    for target in (
        0x0201AA8D,
        0x0206E541,
        0x02071FC9,
