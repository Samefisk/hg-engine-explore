...
#define OW_WILD_MEW_WARP_FIRST      0
...
static const OverworldWildMewWarpDestination sOverworldWildMewWarpDestinations[] = {
    // Outdoor maps with real warp anchors. Let the engine resolve coordinates.
    { MAP_T20, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R29, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T21, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R30, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R31, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_T22, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R32, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R36, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R37, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T27, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R38, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R39, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T26, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T24, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R42, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R43, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T29, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R44, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T30, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T01, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T02, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T04, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T06, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T07, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T08, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T09, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R48, OW_WILD_MEW_WARP_FIRST, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_NONE, OW_WILD_MEW_WARP_DIR_SOUTH },
};
