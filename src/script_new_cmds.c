...
static const OverworldWildMewWarpDestination sOverworldWildMewWarpDestinations[] = {
    // Outdoor route and town positions with explicit safe spawn coordinates.
    ...
    { MAP_T03, OW_WILD_MEW_WARP_NONE, 16, 14, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T05, OW_WILD_MEW_WARP_NONE, 20, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T10, OW_WILD_MEW_WARP_NONE, 20, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T11, OW_WILD_MEW_WARP_NONE, 18, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R01, OW_WILD_MEW_WARP_NONE, 10, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R02, OW_WILD_MEW_WARP_NONE, 10, 24, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R03, OW_WILD_MEW_WARP_NONE, 20, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R04, OW_WILD_MEW_WARP_NONE, 16, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R05, OW_WILD_MEW_WARP_NONE, 10, 16, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R06, OW_WILD_MEW_WARP_NONE, 10, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R07, OW_WILD_MEW_WARP_NONE, 12, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R08, OW_WILD_MEW_WARP_NONE, 20, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R09, OW_WILD_MEW_WARP_NONE, 18, 12, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R10, OW_WILD_MEW_WARP_NONE, 12, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R11, OW_WILD_MEW_WARP_NONE, 18, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R12, OW_WILD_MEW_WARP_NONE, 12, 24, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R13, OW_WILD_MEW_WARP_NONE, 18, 14, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R14, OW_WILD_MEW_WARP_NONE, 10, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R15, OW_WILD_MEW_WARP_NONE, 18, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R16, OW_WILD_MEW_WARP_NONE, 18, 10, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R17, OW_WILD_MEW_WARP_NONE, 12, 26, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R18, OW_WILD_MEW_WARP_NONE, 18, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R22, OW_WILD_MEW_WARP_NONE, 14, 10, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R24, OW_WILD_MEW_WARP_NONE, 10, 18, OW_WILD_MEW_WARP_DIR_NORTH },
    { MAP_R25, OW_WILD_MEW_WARP_NONE, 18, 10, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R26, OW_WILD_MEW_WARP_NONE, 12, 36, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R27, OW_WILD_MEW_WARP_NONE, 22, 14, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R28, OW_WILD_MEW_WARP_NONE, 14, 10, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R33, OW_WILD_MEW_WARP_NONE, 10, 8, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R35, OW_WILD_MEW_WARP_NONE, 12, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R45, OW_WILD_MEW_WARP_NONE, 12, 24, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R46, OW_WILD_MEW_WARP_NONE, 10, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R47, OW_WILD_MEW_WARP_NONE, 12, 14, OW_WILD_MEW_WARP_DIR_SOUTH },

    // Pokemon Center interiors use the same tested safe coordinate.
    ...
    { MAP_T11PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R32PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R10PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R03PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T31PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_D32PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_D47PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_C11PC0101, OW_WILD_MEW_WARP_NONE, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
};
