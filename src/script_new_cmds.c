...
static const OverworldWildMewWarpDestination sOverworldWildMewWarpDestinations[] = {
    // Outdoor route-gate entrance tiles pulled from map warp events.
    { MAP_R29, OW_WILD_MEW_WARP_ID_DIRECT, 454, 293, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R29, OW_WILD_MEW_WARP_ID_DIRECT, 454, 294, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R33, OW_WILD_MEW_WARP_ID_DIRECT, 374, 238, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R33, OW_WILD_MEW_WARP_ID_DIRECT, 374, 237, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R35, OW_WILD_MEW_WARP_ID_DIRECT, 351, 166, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R35, OW_WILD_MEW_WARP_ID_DIRECT, 351, 167, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R38, OW_WILD_MEW_WARP_ID_DIRECT, 524, 156, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R38, OW_WILD_MEW_WARP_ID_DIRECT, 525, 156, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_T05, OW_WILD_MEW_WARP_ID_DIRECT, 1214, 403, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T05, OW_WILD_MEW_WARP_ID_DIRECT, 1215, 403, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T24, OW_WILD_MEW_WARP_ID_DIRECT, 358, 166, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T24, OW_WILD_MEW_WARP_ID_DIRECT, 358, 167, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_W21, OW_WILD_MEW_WARP_ID_DIRECT, 75, 39, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_W21, OW_WILD_MEW_WARP_ID_DIRECT, 75, 40, OW_WILD_MEW_WARP_DIR_WEST },
};
