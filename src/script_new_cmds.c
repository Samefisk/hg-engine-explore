...
#define OW_WILD_MEW_WARP_ID_DIRECT  0
...
static u8 sOverworldWildMewWarpScript[] = {
    ...
    OW_WILD_MEW_WARP_ID_DIRECT & 0xFF, OW_WILD_MEW_WARP_ID_DIRECT >> 8,
    0x07, 0x00,
    0x07, 0x00,
...
static const OverworldWildMewWarpDestination sOverworldWildMewWarpDestinations[] = {
    // Outdoor map warp-event coordinates. Routes use global matrix coordinates.
    { MAP_T20, OW_WILD_MEW_WARP_ID_DIRECT, 3, 3, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R29, OW_WILD_MEW_WARP_ID_DIRECT, 468, 418, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T21, OW_WILD_MEW_WARP_ID_DIRECT, 4, 8, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R30, OW_WILD_MEW_WARP_ID_DIRECT, 467, 461, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R31, OW_WILD_MEW_WARP_ID_DIRECT, 368, 410, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_T22, OW_WILD_MEW_WARP_ID_DIRECT, 352, 368, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R32, OW_WILD_MEW_WARP_ID_DIRECT, 358, 316, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R36, OW_WILD_MEW_WARP_ID_DIRECT, 265, 164, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R37, OW_WILD_MEW_WARP_ID_DIRECT, 422, 175, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T27, OW_WILD_MEW_WARP_ID_DIRECT, 14, 17, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R38, OW_WILD_MEW_WARP_ID_DIRECT, 524, 156, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R39, OW_WILD_MEW_WARP_ID_DIRECT, 633, 169, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T26, OW_WILD_MEW_WARP_ID_DIRECT, 16, 53, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T24, OW_WILD_MEW_WARP_ID_DIRECT, 397, 183, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R42, OW_WILD_MEW_WARP_ID_DIRECT, 650, 198, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R43, OW_WILD_MEW_WARP_ID_DIRECT, 626, 380, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T29, OW_WILD_MEW_WARP_ID_DIRECT, 1203, 453, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R44, OW_WILD_MEW_WARP_ID_DIRECT, 1033, 363, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T30, OW_WILD_MEW_WARP_ID_DIRECT, 1127, 501, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T01, OW_WILD_MEW_WARP_ID_DIRECT, 1309, 131, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T02, OW_WILD_MEW_WARP_ID_DIRECT, 1418, 234, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T04, OW_WILD_MEW_WARP_ID_DIRECT, 1231, 237, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T06, OW_WILD_MEW_WARP_ID_DIRECT, 1039, 502, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T07, OW_WILD_MEW_WARP_ID_DIRECT, 912, 200, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T08, OW_WILD_MEW_WARP_ID_DIRECT, 1308, 229, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T09, OW_WILD_MEW_WARP_ID_DIRECT, 688, 392, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R48, OW_WILD_MEW_WARP_ID_DIRECT, 4, 11, OW_WILD_MEW_WARP_DIR_SOUTH },
};
