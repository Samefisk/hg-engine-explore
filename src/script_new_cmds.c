...
static const OverworldWildMewWarpDestination sOverworldWildMewWarpDestinations[] = {
    // Direct-coordinate outdoor warps. Vanilla warp scripts use warpId 0, not 0xFFFF.
    { MAP_T20, OW_WILD_MEW_WARP_ID_DIRECT, 7, 7, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R29, OW_WILD_MEW_WARP_ID_DIRECT, 14, 9, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T21, OW_WILD_MEW_WARP_ID_DIRECT, 17, 10, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R30, OW_WILD_MEW_WARP_ID_DIRECT, 12, 20, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R31, OW_WILD_MEW_WARP_ID_DIRECT, 10, 9, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_T22, OW_WILD_MEW_WARP_ID_DIRECT, 18, 14, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R32, OW_WILD_MEW_WARP_ID_DIRECT, 10, 24, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R36, OW_WILD_MEW_WARP_ID_DIRECT, 18, 14, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R37, OW_WILD_MEW_WARP_ID_DIRECT, 8, 8, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T27, OW_WILD_MEW_WARP_ID_DIRECT, 20, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R38, OW_WILD_MEW_WARP_ID_DIRECT, 16, 11, OW_WILD_MEW_WARP_DIR_WEST },
    { MAP_R39, OW_WILD_MEW_WARP_ID_DIRECT, 14, 12, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T26, OW_WILD_MEW_WARP_ID_DIRECT, 17, 16, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T24, OW_WILD_MEW_WARP_ID_DIRECT, 20, 20, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R42, OW_WILD_MEW_WARP_ID_DIRECT, 22, 12, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_R43, OW_WILD_MEW_WARP_ID_DIRECT, 10, 20, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T29, OW_WILD_MEW_WARP_ID_DIRECT, 14, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R44, OW_WILD_MEW_WARP_ID_DIRECT, 18, 12, OW_WILD_MEW_WARP_DIR_EAST },
    { MAP_T30, OW_WILD_MEW_WARP_ID_DIRECT, 18, 20, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T01, OW_WILD_MEW_WARP_ID_DIRECT, 14, 10, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T02, OW_WILD_MEW_WARP_ID_DIRECT, 18, 14, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T04, OW_WILD_MEW_WARP_ID_DIRECT, 24, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T06, OW_WILD_MEW_WARP_ID_DIRECT, 16, 18, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T07, OW_WILD_MEW_WARP_ID_DIRECT, 28, 22, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T08, OW_WILD_MEW_WARP_ID_DIRECT, 20, 14, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_T09, OW_WILD_MEW_WARP_ID_DIRECT, 16, 12, OW_WILD_MEW_WARP_DIR_SOUTH },
    { MAP_R48, OW_WILD_MEW_WARP_ID_DIRECT, 12, 14, OW_WILD_MEW_WARP_DIR_SOUTH },
};
