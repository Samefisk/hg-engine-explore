...
def measurement_inputs(test, root):
    if not test.get("measurements"):
        return {}
    fixed_contract = ("unmounted-cadence-v1", "unmounted-game-cadence-v1", "center-entry-exit-v1", "cyndaquil-normal-setup-v1", "live-route-control-v1", "packaged-resolver-parity-v1", "packaged-condition-service-v1", "actor-binding-context-v1", "actor-inspect-handle-v1", "live-walk-policy-control-v1", "mounted-frame-pacing-v1", "mounted-control-stress-v1", "mount-detach-follower-resume-v1", "mounted-hop-arc-v1", "mounted-nearest-diagonal-v1", "live-mount-pose-control-v1", "wild-walk-v1", "wild-ledge-v1", "wild-teleport-v1", "runner-stop-skid-v1", "runner-turn-runway-v1", "appear-hop-timing-v1", "wild-transition-invalidation-v1", "follower-transition-rebind-v1", "mounted-streaming-path-v1", "mounted-cardinal-streaming-v1", "mounted-walk-transition-v1", "land-surf-separation-v1", "population-fast-travel-v1", "mounted-teleport-matrix-v1", "live-wild-clear-control-v1", "turn-skid-v1", "wild-battle-handoff-v1", "mounted-hop-transition-v1", "warp-gate-v1", "diagonal-corner-v1", "live-corner-control-v1", "mounted-frame-matrix-v1", "live-walk-matrix-control-v1", "mounted-stomp-v1", "live-stomp-control-v1", "mounted-crash-v1", "live-crash-control-v1", "live-condition-controller-v1", "notice-player-runtime-v1", "stalker-runtime-v1", "playful-runtime-v1", "startled-runtime-v1", "fly-in-runtime-v1", "waddle-runtime-v1", "held-control-runtime-v1")
    fixed_contract += ("blocked-wild-facing-v1", "mounted-speed-slew-v1",
